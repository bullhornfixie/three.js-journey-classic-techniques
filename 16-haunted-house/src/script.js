...
const tick = () =>
{
    ...
    // Update ghosts 
    const ghost1Angle = elapsedTime * 0.5 // equiv of / 2
    ghost1.position.x = Math.cos(ghost1Angle) * 4
    ghost1.position.z = Math.sin(ghost1Angle) * 4
    ghost1.position.y = Math.sin(elapsedTime * 3)

    const ghost2Angle = - elapsedTime * 0.32 // by changing to - moves in opposite ditrection
